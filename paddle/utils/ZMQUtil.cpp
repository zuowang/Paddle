...
bool ZMQUtil::ZMQRecvAsync(zmq::socket_t *sock, int32_t *zmq_id,
                           zmq::message_t *msg) {
...
size_t ZMQUtil::ZMQSend(zmq::socket_t *sock, int32_t zmq_id,
                        zmq::message_t &msg, int flag) {
  size_t zid_sent_size = ZMQSend(sock, &zmq_id, sizeof(zmq_id),
                                 flag | ZMQ_SNDMORE);
